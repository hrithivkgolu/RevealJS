...
# --- ORIGINAL PYTHON CODE AS STRING (for embedding in HTML) ---
code_body = r'''
# Email for verification: 24f2000717@ds.study.iitm.ac.in
...
# Escape the code so HTML displays it safely
...
html_base = mpld3.fig_to_html(plt.gcf())

# Insert email + code block
injected_html = f"""
<p>Email for verification: 24f2000717@ds.study.iitm.ac.in</p>
<h2>Python Code Used to Generate This Visualization</h2>
<pre style="background:#1e1e1e;color:#dcdcdc;padding:12px;border-radius:10px;overflow-x:auto;">
